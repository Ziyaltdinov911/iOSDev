...
let trunkCar2 = TrunkCar(brand: "FAW", model: "J6", year: 2014, cargoCapacity: 12_000, cargoType: "Diesel car")
let sportCar2 = SportCar(brand: "Audi", model: "A4", year: 2009, maxSpeed: 250, overlock: 6.7)

trunkCar2.loadCargo(weight: 10_000)
trunkCar2.uploadCargo(weight: 8_000)

sportCar2.overlocking()
sportCar2.braking()

print("Свойства грузового автомобиля:")
print("Марка: \(trunkCar2.brand)")
print("Модель: \(trunkCar2.model)")
print("Год выпуска: \(trunkCar2.year)")
print("Грузоподъемность: \(trunkCar2.cargoCapacity) кг")
print("Тип груза: \(trunkCar2.cargoType)\n")

print("Свойства спортивного автомобиля:")
print("Марка: \(sportCar2.brand)")
print("Модель: \(sportCar2.model)")
print("Год выпуска: \(sportCar2.year)")
print("Максимальная скорость: \(sportCar2.maxSpeed) км/ч")
print("Разгон: \(sportCar2.overlock) сек")
